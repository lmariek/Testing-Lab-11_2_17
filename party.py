...
def is_mel(name, email):
    """Is this user Mel?
        ...
        >>> is_mel("Mel Melitpolski", "hoot@me.com")
        True

        >>> is_mel("Bel Melitpolski", "mel@ubermelon.com")
        True
    ...
    email = email.lower()
    name = name.lower()
    if name == "mel" or name == "mel melitpolski":
        name = "Mel Melitpolski"
...
def most_and_least_common_type(treats):
    """Given list of treats, return most and least common treat types.
        ...
        If they are the same, you should change code to say bring anything else.
